...
import mediaclub.app.appwanderlust.Adapters.SliderAdapter;
...
public class ViewPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            post = (Post) savedInstanceState.getSerializable("MYPOST");
        }
    ...
    private void getPostImages() {
        ...
        final ProgressDialog pDialog = new ProgressDialog(ViewPostActivity.this);
...
//                }
                            ...
                            //Toast.makeText(ViewPostActivity.this, obj.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                pDialog.hide();
                //Toast.makeText(ViewPostActivity.this, error.getMessage() + "hi", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.diary_post_menu, menu);
        return true;
    }
...
//            startActivity(parentIntent);
            ...
            Intent i = new Intent(ViewPostActivity.this, EditPost.class);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putSerializable("MYPOST", post);
    }
}
